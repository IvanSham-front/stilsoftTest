  ...
  <table class="table">
        ...
        <tbody>
            ...
            >
                ...
                <td>{{student.sections.join(', ')}}</td>

                <button class="btn btn-outline-danger" type="button" v-on:click="$emit('remove-student', student.id)">delete</button>
            </tr>
        </tbody>
